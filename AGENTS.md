...
Before changing app release artifacts, release notes, publication flow, checksums, download structure, or security/privacy behavior, read the source-of-truth documents in the Home Assistant integration repo:
...
`pcvantol/djconnect-app-releases` is a public release/distribution surface for community/non-signed app artifacts and release metadata.
...
- Keep app artifacts, manifests, checksums, and release notes aligned.
